...
**Timing:** 1 hour, 24 hours, and 48 hours after the click.  
...
| **3** | 48 hours after click | Last follow-up. Then I leave you alone. | Respectful, low-pressure, final offer | One last chance, then graceful exit |
...
**From name:** [Founder Name] from BarMatrix  
...
>
> **2. You weren't sure it was worth $499.**
> Fair. Let me reframe it: the diagnostic is free. The repair is $499. The stuck score is expensive. One MBE point can be the difference between passing and failing. The MBE is worth 50% of your bar score. If your top 3 traps are costing you 10 questions, that's 11 points. In most jurisdictions, 5–10 points is the difference between passing and failing. $499 to fix the patterns that cost you 11 points? The ROI is immediate.
>
...
>
> Whatever the reason, here's what I want you to know: the July 2026 Founding Cohort discount is still open. **$499.** Or **$250 + $249** in 30 days.
>
...
- **The ROI calculation:** Repeat the "11 points" math from the pricing page. Make it a callout box with bold text.
...
| **CTA text** | "Complete My Enrollment" | "Reserve My Spot — $499" | "Reserve" creates scarcity; "Complete" reduces friction |
| **P.S. line** | "Reply to this email" | "P.S. — The July 2026 cohort is capped at 500 students. [X] spots left." | Scarcity in P.S. outperforms personal reply offer |
...
>
> **"$499 is too much for a supplement."**
> I get it. But here's the math: the MBE is 50% of your bar score. Each question is ~1.14 points. If your top 3 traps cost you 10 questions, that's 11 points. 5–10 points is the pass/fail margin in most states. $499 for 11 points? That's the best ROI in bar prep.
>
> **"I don't have time."**
...
>
> But maybe your objection is different. Maybe it's something I haven't thought of. If so, reply and let me know. I'll address it directly.
>
> [Founder Name]  
> BarMatrix
>
> P.S. — If you decide to enroll, the discount is still here: **[Complete My Enrollment →]**. But after this email, I won't mention it again.
...
**Send:** 48 hours after Email 2 (if no purchase)  
...
> [First Name],
>
> This is my last email about Flagship. If you haven't enrolled by now, you're either not ready or not interested. Both are fine.
>
> I won't send you any more sales emails. I won't nag you. I won't drop the price or extend the deadline. I respect your decision either way.
>
...
> BarMatrix
>
> P.S. — If you change your mind before the deadline, the discount is still here. But after this email, I won't mention it again. I hope you find what you need, whether it's BarMatrix or something else.
...
IF user does NOT purchase within 48 hours of Email 2
  THEN send Email 3
...
| Scenario | Adjustment |
|----------|------------|
| User is within 48 hours of the deadline | Accelerate the sequence. Send Email 1 immediately, Email 2 in 6 hours, Email 3 in 12 hours. |
