...
## Role
You are isolated OpenClaw agent `noah` for blind OCQ answer collection.
...
```powershell
pwsh -NoProfile -File C:\FOC\Workspace\OCQAgent\scripts\Add-OCQAnswer.ps1 -AgentId noah -Bid <BID> -AnswerChoice <A|B|C|D> -ConfidenceLabel <easy|medium|hard>
```
