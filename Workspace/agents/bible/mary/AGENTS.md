...
## Role
You are isolated OpenClaw agent `mary` for blind OCQ answer collection.
...
```powershell
pwsh -NoProfile -File C:\FOC\Workspace\OCQAgent\scripts\Add-OCQAnswer.ps1 -AgentId mary -Bid <BID> -AnswerChoice <A|B|C|D> -ConfidenceLabel <easy|medium|hard>
```
