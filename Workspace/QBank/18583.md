...
BARMATRIX Q#: 18583
internal_id: contracts_content_meaning_questions_batch_007_CM_C_PER_exceptions_purposes::r2::Q01
subject_display: Contracts
topic: PER exceptions and purposes
subtopic: CM-C
difficulty: Core Diagnostic
L2: Moses signed a written agreement to have Bezalel paint his house for $9,000. The writing stated the price, the work to be done, and the completion date, bu
Stem / Fact Pattern: Moses signed a written agreement to have Bezalel paint his house for $9,000. The writing stated the price, the work to be done, and the completion date, but did not mention financing. Before signing, both parties orally agreed that the writing would not become binding unless Moses’s bank approved a home-improvement loan by Friday. The bank rejected the loan. Bezalel sues for breach, and Moses offers evidence of the oral financing condition.
Answer A: No, because the written agreement is detailed and the oral condition is not included in it.
Answer B: Yes, because evidence of an oral condition precedent to the effectiveness of the writing is not offered to vary a duty under an effective contract.
Answer C: No, because any prior oral agreement is barred once the parties sign a written contract.
Answer D: Yes, but only if Moses first proves that Bezalel breached the painting agreement.
Correct Answer: B
Correct Answer Explanation: Evidence of a prior oral condition precedent may be admitted to show that the written agreement never became effective unless the condition occurred. Moses is not trying to change the painting duty; he is trying to show that no duty arose because the loan condition failed.
Wrong Answer Explanations: A: A is wrong because detail in the writing does not automatically bar condition-precedent evidence. C: C is wrong because the parol evidence rule is not an absolute bar on every prior oral statement. D: D is wrong because the issue is whether a duty arose, not whether Bezalel later breached.
lb_rule_reference: Common-law PER / condition precedent exception
