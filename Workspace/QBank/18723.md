...
Wrong Answer Explanations: Although real estate brokerage contracts frequently require payment of the commission when the broker procures a ready, willing, and able buyer, A and C are incorrect because this contract was conditioned on the transfer of title. “Frustration of purpose” may excuse performance of a contract where an unforeseen event destroys the underlying reasons for performing the contract. D is incorrect because the doctrine of frustration of purpose never results in liability but rather excuses a party's failure to perform.
