...
BARMATRIX Q#: 20479
internal_id: contracts_content_meaning_questions_batch_006_CM_B_final_discrimination_set::r5::Q04
subject_display: Contracts
topic: Parol Evidence Rule Core — Final Discrimination Set
subtopic: CM-B
difficulty: Core Diagnostic
L2: Naomi hired Solomon to design a courtyard. The parties signed a detailed writing that stated it was “the complete and exclusive statement of all terms betw
Stem / Fact Pattern: Naomi hired Solomon to design a courtyard. The parties signed a detailed writing that stated it was “the complete and exclusive statement of all terms between the parties.” The writing listed paths, trees, benches, price, and completion date. Before signing, Solomon orally promised to include a stone fountain at no added charge. Naomi offers the oral promise.
Answer A: Yes, because the fountain promise is consistent with the written terms.
Answer B: Yes, because silence in the writing always permits a consistent oral term.
Answer C: No, because a complete and exclusive integration bars even consistent additional prior terms.
Answer D: No, but only because courtyard-design contracts are governed by Article 2.
Correct Answer: C
Correct Answer Explanation: A complete and exclusive integrated writing bars prior or contemporaneous consistent additional terms. The fountain promise adds an omitted obligation to the complete writing.
Wrong Answer Explanations: A: A is wrong because consistency is not enough when the writing is complete and exclusive. B: B is wrong because silence does not automatically permit supplementation. D: D is wrong because this is a services contract governed by common-law principles, not Article 2.
