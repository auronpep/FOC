...
subtopic: Prior Restraint
L2: A city ordinance requires any group of 25 or more persons to obtain a parade permit before marching on public streets. The ordinance provides that the city
Stem / Fact Pattern: A city ordinance requires any group of 25 or more persons to obtain a parade permit before marching on public streets. The ordinance provides that the city clerk "shall issue or deny the permit within seven days in the exercise of reasonable discretion." No criteria are provided for granting or denying the permit. No standards limit the applicable fee. A permit is denied to a group seeking to hold a march on the basis that the clerk determined the march was "unlikely to be well-received by the community."
Call of Question: The permit ordinance is:
Answer A: Constitutional, because requiring advance notice for parades is a reasonable content-neutral TPM regulation that protects public safety without targeting any message
Answer B: Unconstitutional only as applied, because the clerk's stated reason — "unlikely to be well-received" — was impermissible content discrimination
Answer C: Facially unconstitutional, because the ordinance vests the city clerk with standardless discretion and provides no criteria limiting the basis for denial or the fee amount
Answer D: Constitutional because the seven-day decision period gives the applicant prompt review, satisfying the due process requirements for prior restraints on speech
Correct Answer: C
Correct Answer Explanation: A permit system for expressive activity in a public forum must include objective standards constraining the official's discretion, prompt decision procedures, and access to judicial review. Under Forsyth County v. Nationalist Movement and Lovell v. City of Griffin, a permit system that vests officials with unguided discretion to grant or deny permits is an unconstitutional prior restraint on its face. Here, the ordinance provides no criteria beyond "reasonable discretion" and no limits on the fee, making it facially invalid. The clerk's listener-reaction rationale illustrates precisely why standardless discretion is unconstitutional.
Wrong Answer Explanations: A: While a facially neutral advance-notice permit requirement can be constitutional, the ordinance here vests the clerk with "reasonable discretion" and provides no criteria. Standardless discretion in a permit system for expression is unconstitutional regardless of the stated neutral purpose. The absence of criteria allows denial based on content or viewpoint — as evidenced by the actual denial here based on anticipated community reception. B: The ordinance is facially unconstitutional, not merely as-applied unconstitutional. A permit ordinance that vests officials with standardless "reasonable discretion" is facially void because it allows — indeed invites — content-based denials. The problem is not only the clerk's specific reasoning but the structure of the ordinance, which provides no standards to channel or constrain discretion. Facially unconstitutional permit ordinances can be challenged facially; fixing this specific denial would not remedy the systemic problem. D: Promptness of decision is one of the procedural requirements for a constitutionally valid permit system, but it is not the only one. The system must also provide objective criteria constraining the official's discretion, a provision for prompt judicial review, and — under Forsyth County — a fee structure that cannot be adjusted based on audience reaction or the official's assessment of the march's content. Seven-day turnaround satisfies one prong but does not remedy standardless discretion.
lb_rule_reference: Under Forsyth County v. Nationalist Movement, a permit system for public demonstrations is unconstitutional if it grants officials unbridled discretion to grant or deny permits, if fees are tied to the anticipated crowd reaction (listener-based costs), or if the system lacks adequate procedural safeguards including prompt action and judicial review.
