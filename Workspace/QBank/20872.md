...
BARMATRIX Q#: 20872
internal_id: contracts_content_meaning_questions_batch_006_CM_B_final_discrimination_set::r9::Q08
subject_display: Contracts
topic: Parol Evidence Rule Core — Final Discrimination Set
subtopic: CM-B
difficulty: Core Diagnostic
L2: Leah agreed in a signed goods contract to buy monthly shipments of grain from Isaac. The writing contained a merger clause but was silent on whether Leah c
Stem / Fact Pattern: Leah agreed in a signed goods contract to buy monthly shipments of grain from Isaac. The writing contained a merger clause but was silent on whether Leah could return undamaged sacks. During the first four months, Isaac accepted Leah’s returns of undamaged sacks without objection. In month five, Isaac refuses a similar return and argues that the merger clause bars evidence of the first four months.
Answer A: No, because a merger clause bars all course-of-performance evidence.
Answer B: No, because conduct after signing can never affect contract meaning.
Answer C: Yes, because course of performance under the same contract may explain or supplement the agreement under Article 2.
Answer D: Yes, but only if Leah proves that Isaac intended to modify the contract in writing.
Correct Answer: C
Correct Answer Explanation: Under Article 2, course of performance under the same agreement may explain or supplement the contract, even when the writing is final. The repeated accepted returns can help define the parties’ understanding of an omitted return term.
Wrong Answer Explanations: A: A is wrong because a merger clause does not automatically bar UCC course-of-performance evidence. B: B is wrong because post-signing performance under the same contract can be an interpretive source. D: D is wrong because the evidence can be used as interpretation even without a written modification.
lb_rule_reference: UCC course of performance despite merger clause
