...
L2: Congress enacts a statute making it a federal crime to transmit "indecent" material over the internet in a manner that can be viewed by persons under the a
Stem / Fact Pattern: Congress enacts a statute making it a federal crime to transmit "indecent" material over the internet in a manner that can be viewed by persons under the age of 18. The term "indecent" is defined to include sexually explicit material that is not obscene under Miller but would be considered offensive to community standards for minors. A digital rights organization challenges the statute as an unconstitutional content-based restriction on protected speech.
Call of Question: The statute's constitutional defect is best described as:
Answer A: The statute is constitutional because Congress may regulate indecent material on a medium accessible to children at home, just as the FCC regulates indecent broadcast content under Pacifica
Answer B: The statute is overbroad because, in the absence of effective age-verification technology, restricting "indecent" material accessible to minors necessarily suppresses a substantial amount of protected adult speech
Answer C: The statute is constitutional as a content-neutral regulation because protecting minors from harmful content is unrelated to suppressing any message
Answer D: The statute is constitutional because protecting minors from indecent material online is a compelling interest that the restriction is narrowly tailored to serve
Correct Answer: B
Correct Answer Explanation: Reno v. ACLU struck down the Communications Decency Act on two grounds: (1) the internet receives full First Amendment protection, requiring strict scrutiny for content-based restrictions; and (2) the indecency restriction was overbroad because any effective restriction on what minors could access would necessarily restrict adults' access to the same protected speech. Without reliable age-verification tools, blocking minors' access effectively blocked everyone's access to protected content. The statute fails both strict scrutiny and overbreadth analysis.
Wrong Answer Explanations: A: Reno v. ACLU rejected the Pacifica rationale for the internet. Broadcast's reduced protection rests on spectrum scarcity and the pervasive-intrusion-into-the-home theory. The internet is not a scarce resource, and users actively seek content rather than passively receiving it. The internet receives full, print-like First Amendment protection. Content-based restrictions on internet speech require strict scrutiny, not the more permissive Pacifica framework. C: Content-neutrality is determined by whether the law draws distinctions based on the content of the speech — not by whether the government's motive is sympathetic. A law defining "indecent" material by its sexual content and restricting it is content-based by definition, regardless of the motivating reason. Child protection is not a content-neutral purpose when the restriction specifically targets certain content categories. D: A compelling interest is necessary but not sufficient for strict scrutiny. The restriction must also be narrowly tailored. A broadly worded "indecency" restriction applied to the entire internet is not narrowly tailored because it suppresses substantial amounts of protected adult speech in the absence of effective age-verification tools. The narrow tailoring prong fails under Reno. A compelling interest alone does not validate a content-based restriction.
lb_rule_reference: Under Reno v. ACLU, the Internet is entitled to the highest level of First Amendment protection — comparable to print media — because it is not a scarce resource. Content-based restrictions on internet speech must satisfy strict scrutiny.
