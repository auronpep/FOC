...
BARMATRIX Q#: 20436
internal_id: contracts_content_meaning_questions_batch_006_CM_B_final_discrimination_set::r12::Q11
subject_display: Contracts
topic: Parol Evidence Rule Core — Final Discrimination Set
subtopic: CM-B
difficulty: Trap Repair
L2: Martha hired Peter to repair a roof under a signed services contract. One week after signing, Martha orally asked Peter to add a skylight for an additional
Stem / Fact Pattern: Martha hired Peter to repair a roof under a signed services contract. One week after signing, Martha orally asked Peter to add a skylight for an additional price, and Peter bought materials for the skylight. Martha later refuses to pay for the skylight, arguing that the parol evidence rule bars proof of any oral agreement not included in the signed roof contract.
Answer A: Yes, because the signed writing bars every oral statement connected to the project.
Answer B: Yes, because a skylight is related to the same roof and therefore contradicts the writing.
Answer C: No, because the skylight request was made after the written contract and must be analyzed as a possible modification or waiver issue, not a parol-evidence issue.
Answer D: No, but only because services contracts are governed by Article 2.
Correct Answer: C
Correct Answer Explanation: The parol evidence rule addresses prior or contemporaneous agreements offered to vary a final writing. A later oral request after the contract is signed is not barred by PER; its effect must be analyzed under modification, waiver, or reliance doctrines.
Wrong Answer Explanations: A: A is wrong because PER does not bar every oral statement related to the transaction. B: B is wrong because timing comes before contradiction analysis. D: D is wrong because roof repair is a services contract and the point is timing, not Article 2.
lb_rule_reference: Subsequent oral change / PER timing error
