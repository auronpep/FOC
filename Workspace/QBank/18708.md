...
L2: The plaintiff was injured when she fell down a flight of steps at a bartending school. She subsequently sued the school for damages, asserting that the acc
...
Answer A: A: granted, since the doctor's opinion is not based on matters within her personal knowledge.
Answer B: B: granted, since the doctor's opinion is based on matters not in evidence.
Answer C: C: denied, since the doctor was testifying in response to a hypothetical question.
Answer D: D: denied, since an expert's testimony may be based on observations made in the courtroom.
Correct Answer: C
Correct Answer Explanation: An expert may testify in answer to a hypothetical question so long as the facts assumed in that hypothetical have been established (or will be established) by the evidence offered. Since the plaintiff's case involves the assertion that her fall down the stairs resulted in her injury, it was proper for the school's attorney to ask for the doctor's opinion as to whether such an injury was possible given such facts.
Wrong Answer Explanations: The expert's answer may be based on the facts assumed in the hypothetical and need not be based on facts actually in evidence or known by him or her. A and B are therefore incorrect. Although an expert's opinion may be based on observations made in the courtroom, D is incorrect because the doctor's was not.
