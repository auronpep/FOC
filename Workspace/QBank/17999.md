...
BARMATRIX Q#: 17999
internal_id: contracts_content_meaning_questions_batch_006_CM_B_final_discrimination_set::r4::Q03
subject_display: Contracts
topic: Parol Evidence Rule Core — Final Discrimination Set
subtopic: CM-B
difficulty: Discriminator
L2: Moses hired Bezalel to provide “weekly status reports” during a building project. Their signed services contract contained a merger clause and stated that
Stem / Fact Pattern: Moses hired Bezalel to provide “weekly status reports” during a building project. Their signed services contract contained a merger clause and stated that it was the complete and exclusive agreement. A dispute later arises over whether “weekly status reports” must be written or may be oral. Moses offers negotiation evidence that both parties used the phrase to mean a one-page written summary.
Answer A: No, because a complete and exclusive writing bars all negotiation evidence for every purpose.
Answer B: No, because the evidence would add a new reporting duty not contained in the writing.
Answer C: Yes, but only if Moses first proves that Bezalel failed to send any reports at all.
Answer D: Yes, because the evidence is offered to explain an ambiguous term, not to add a separate term.
Correct Answer: D
Correct Answer Explanation: Even a complete integration does not bar evidence offered to explain an ambiguous term. The evidence defines what the written phrase “weekly status reports” meant; it does not add an outside reporting obligation.
Wrong Answer Explanations: A: A is wrong because a merger clause does not bar all interpretive evidence. B: B is wrong because the writing already contains a reporting duty; the evidence explains its meaning. C: C is wrong because admissibility of interpretation evidence does not depend on first proving breach.
lb_rule_reference: Common-law PER / ambiguity despite complete integration
