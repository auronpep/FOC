...
BARMATRIX Q#: 17214
internal_id: contracts_content_meaning_questions_batch_007_CM_C_PER_exceptions_purposes::r9::Q08
subject_display: Contracts
topic: PER exceptions and purposes
subtopic: CM-C
difficulty: Core Diagnostic
L2: David hired Ezra under a signed consulting agreement stating that Ezra would prepare “monthly reports.” The agreement contained a merger clause. A dispute
Stem / Fact Pattern: David hired Ezra under a signed consulting agreement stating that Ezra would prepare “monthly reports.” The agreement contained a merger clause. A dispute arises over whether “monthly reports” means written reports or oral briefings at monthly meetings. David offers negotiation emails showing that both parties used “monthly reports” to mean written summaries.
Answer A: Yes, because they are offered to explain an ambiguous term, not to add a new reporting obligation.
Answer B: No, because the merger clause bars all evidence outside the writing.
Answer C: No, because prior emails are parol evidence even when offered to explain ambiguity.
Answer D: Yes, but only if Ezra first admits that the term is ambiguous.
Correct Answer: A
Correct Answer Explanation: Extrinsic evidence may be admitted to explain an ambiguous term, even when the writing is integrated. The emails help determine what the written phrase meant; they do not add a new obligation.
Wrong Answer Explanations: B: B is wrong because merger clauses do not bar all explanatory evidence. C: C is wrong because prior writings can be parol but may still be admissible for a permitted purpose, such as explaining ambiguity. D: D is wrong because the opposing party need not concede ambiguity for the court to find the term reasonably susceptible to more than one meaning.
lb_rule_reference: Common-law PER / ambiguity explanation
