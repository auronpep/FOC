...
L2: Article 2 of the UCC applies
Stem / Fact Pattern: Article 2 of the UCC applies
Answer A: A: only to transactions in goods.
Answer B: B: only to transactions involving merchants.
Answer C: C: to all commercial transactions.
Answer D: D: only to transactions in goods or services.
Correct Answer: A
Correct Answer Explanation: UCC §2-102 provides that “this Article applies to transactions in goods.” Although many of the sections of Article 2 create special rules for transactions involving merchants, many other sections apply to all transactions in goods, whether the parties are merchants or not. Therefore, B is incorrect. C is incorrect because many commercial transactions (e.g., sales of realty) are not “transactions in goods” and, therefore, are not covered by Article 2. D is incorrect because transactions in services are not covered by Article 2.
