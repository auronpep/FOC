...
subtopic: Content-Based vs. Content-Neutral Restrictions
L2: A city enacts an ordinance making it a misdemeanor to place on public or private property "any symbol, object, appellation, characterization, or graffiti t
Stem / Fact Pattern: A city enacts an ordinance making it a misdemeanor to place on public or private property "any symbol, object, appellation, characterization, or graffiti that one knows or has reasonable grounds to know arouses anger, alarm, or resentment in others on the basis of race, color, creed, religion, or gender." The ordinance is enacted in response to incidents where individuals placed racially charged symbols on the property of minority-owned businesses. A defendant is charged under the ordinance after placing a symbol associated with racial supremacist ideology on a neighbor's fence. The defendant challenges the ordinance on First Amendment grounds.
Call of Question: The defendant's First Amendment challenge is most likely to succeed because:
Answer A: The ordinance is constitutional because hate speech that targets persons based on race or religion is not protected by the First Amendment under current doctrine
Answer B: The ordinance, as written, selectively restricts a subset of fighting words — those based on race or religion — while leaving other fighting words unregulated, constituting impermissible viewpoint discrimination within an unprotected category
Answer C: The ordinance is constitutional because symbolic actions that communicate racial supremacy are conduct, not speech, and the government may regulate conduct under O'Brien without implicating the First Amendment
Answer D: The ordinance fails because protecting persons from racial or religious offense is not a compelling government interest sufficient to restrict protected speech
Correct Answer: B
Correct Answer Explanation: In R.A.V. v. City of St. Paul, the Supreme Court held that even within unprotected categories of speech, the government may not engage in viewpoint discrimination. Fighting words (or other low-value speech) based on race or religion are punished while fighting words based on other characteristics — political affiliation, appearance, etc. — are not. This selectivity within the category of fighting words is viewpoint discrimination: the government is singling out particular content within the unprotected category for special sanction. That content-based discrimination is unconstitutional under R.A.V. even if all the targeted speech would independently qualify as fighting words.
Wrong Answer Explanations: A: The Supreme Court has not recognized a general "hate speech" exception to the First Amendment. In R.A.V. v. City of St. Paul, the Court struck down a bias-motivated crime ordinance specifically targeting symbols and conduct that "arouses anger, alarm, or resentment" based on race, religion, etc. The ordinance at issue in this question closely tracks the ordinance in R.A.V. Speech expressing hatred toward groups is protected unless it falls into an established unprotected category (true threats, incitement, fighting words, obscenity, etc.). C: Placing a symbol on property is expressive conduct intended to convey a particularized message — it qualifies as protected symbolic speech under Spence and related doctrine. The government's ordinance targets the expressive character of the symbol (its racial connotation) — it is content-based, not content-neutral. O'Brien does not apply to laws that target the communicative impact of expressive conduct. D: This answer frames the problem as a strict scrutiny failure, which is technically applicable but misses the specific and more precise reason the ordinance is unconstitutional — viewpoint discrimination within an unprotected category. The R.A.V. holding does not rest primarily on the interest's insufficiency; it rests on the impermissibility of selectively targeting a subset of fighting words based on viewpoint. The ordinance fails for the structural reason of viewpoint discrimination within a category, not only because the interest is insufficient.
lb_rule_reference: Under R.A.V. v. City of St. Paul and Matal v. Tam, the government may not single out speech based on hostility to the viewpoint it expresses — including speech based on race, religion, or sexual orientation — even when the speech is considered hateful or offensive. The established unprotected categories (true threats, incitement, fighting words) must be applied without viewpoint discrimination.
