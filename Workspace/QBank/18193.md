...
BARMATRIX Q#: 18193
internal_id: contracts_content_meaning_questions_batch_007_CM_C_PER_exceptions_purposes::r4::Q03
subject_display: Contracts
topic: PER exceptions and purposes
subtopic: CM-C
difficulty: Core Diagnostic
L2: Sarah bought a bakery from Elijah under a written sale contract containing a merger clause. Sarah later discovers that, before signing, Elijah intentionall
Stem / Fact Pattern: Sarah bought a bakery from Elijah under a written sale contract containing a merger clause. Sarah later discovers that, before signing, Elijah intentionally lied that the bakery had passed a required health inspection. Sarah seeks to introduce Elijah’s statement to rescind the contract for fraud. Elijah objects that the merger clause bars all prior statements.
Answer A: Yes, because evidence offered to prove fraud in the inducement is not barred merely because the contract is integrated.
Answer B: No, because a merger clause bars all prior oral statements for every purpose.
Answer C: No, because fraud evidence is admissible only if the lie appears in the final writing.
Answer D: Yes, but only to determine damages after Sarah proves breach of a written term.
Correct Answer: A
Correct Answer Explanation: The parol evidence rule does not bar evidence offered to avoid a contract for fraud. Sarah is not offering the statement to add a contractual term; she is offering it to prove a defense or equitable ground to rescind.
Wrong Answer Explanations: B: B is wrong because merger clauses are strong integration evidence but do not bar all avoidance evidence. C: C is wrong because fraud may be proved by extrinsic evidence. D: D is wrong because the point is contract avoidance, not damages after breach.
lb_rule_reference: PER defense exception / fraud
