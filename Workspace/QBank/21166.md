...
BARMATRIX Q#: 21166
internal_id: contracts_content_meaning_questions_batch_006_CM_B_final_discrimination_set::r16::Q15
subject_display: Contracts
topic: Parol Evidence Rule Core — Final Discrimination Set
subtopic: CM-B
difficulty: Calibration
L2: Jonah agreed in a signed writing to deliver 50 cedar beams to “the Jerusalem warehouse.” The writing was detailed and stated that it was the complete and e
Stem / Fact Pattern: Jonah agreed in a signed writing to deliver 50 cedar beams to “the Jerusalem warehouse.” The writing was detailed and stated that it was the complete and exclusive agreement. Before signing, Jonah orally told Gideon that delivery would be to the Bethany warehouse instead. Jonah later delivers to Bethany and offers the prior oral statement to show that delivery there was proper.
Answer A: Yes, because prior oral statements by a contracting party are always admissible to show intent.
Answer B: No, because it contradicts the unambiguous written delivery term in a complete and exclusive writing.
Answer C: Yes, because delivery location is always supplied by trade usage rather than express terms.
Answer D: No, but only because this is a goods contract and Article 2 never allows extrinsic evidence.
Correct Answer: B
Correct Answer Explanation: A prior oral statement that directly contradicts an unambiguous express term in a complete and exclusive writing is barred. The writing says Jerusalem; the oral statement says Bethany.
Wrong Answer Explanations: A: A is wrong because prior statements are not automatically admissible to vary a final writing. C: C is wrong because an express delivery term controls over a contradictory prior statement. D: D is wrong because Article 2 can allow explanatory or supplemental evidence; the problem here is direct contradiction of an express term.
lb_rule_reference: Unambiguous express term / contradictory prior oral statement
