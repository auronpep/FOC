...
BARMATRIX Q#: 17560
internal_id: contracts_content_meaning_questions_batch_006_CM_B_final_discrimination_set::r7::Q06
subject_display: Contracts
topic: Parol Evidence Rule Core — Final Discrimination Set
subtopic: CM-B
difficulty: Core Diagnostic
L2: Daniel hired Hannah to install a “premium protection system” in his store. Before the final contract, Hannah gave Daniel a written proposal stating that “p
Stem / Fact Pattern: Daniel hired Hannah to install a “premium protection system” in his store. Before the final contract, Hannah gave Daniel a written proposal stating that “premium protection system” meant cameras plus motion sensors. The final signed contract used the phrase “premium protection system” but did not define it and did not incorporate the proposal. Hannah offers the proposal to explain the phrase.
Answer A: No, because written proposals made before a final contract are never parol evidence.
Answer B: Yes, if offered to explain the ambiguous phrase rather than to add a separate obligation.
Answer C: No, because the proposal was written and therefore can only be used if physically attached to the contract.
Answer D: Yes, but only to prove that Daniel breached the contract.
Correct Answer: B
Correct Answer Explanation: A prior writing outside the final agreement is parol evidence, but parol evidence may be admissible to explain an ambiguous term. The proposal is offered to define “premium protection system,” not to add a separate unrelated term.
Wrong Answer Explanations: A: A is wrong because prior writings can be parol evidence. C: C is wrong because attachment is not required for ambiguity explanation, though incorporation would be a different route. D: D is wrong because the offered purpose is interpretation before the merits.
lb_rule_reference: Prior writing under PER / ambiguity explanation
