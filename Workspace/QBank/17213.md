...
topic: Negligence
subtopic: Standard of care - physical disability
L2: A driver with a permanent hearing impairment drove with legal adaptive mirrors and visual alerts. At an intersection, he did not hear an ambulance siren be
Stem / Fact Pattern: A driver with a permanent hearing impairment drove with legal adaptive mirrors and visual alerts. At an intersection, he did not hear an ambulance siren behind him, but he saw the ambulance lights in his mirror and had several seconds to pull over safely. He continued driving because he was distracted by a text message.
Call of Question: Which standard of care should the jury apply? ### A. The care a reasonably prudent driver with the same hearing impairment would use under the circumstances. - **Correct.** Physical disability is considered in framing the objective standard, but distraction can still be unreasonable. ### B. The care of an average driver with perfect hearing. - **Wrong.** The standard accounts for physical disability rather than pretending the impairment does not exist. ### C. The driver's own personal best effort, even if unreasonable by objective standards. - **Wrong.** The standard remains objective; it is not whatever this defendant subjectively thought was enough. ### D. No negligence standard applies because physical disability always excuses failure to respond to traffic conditions. - **Wrong.** Physical disability adjusts the standard; it does not create blanket immunity.
Answer A: The care a reasonably prudent driver with the same hearing impairment would use under the circumstances
Answer B: The care of an average driver with perfect hearing
Answer C: The driver's own personal best effort, even if unreasonable by objective standards
Answer D: No negligence standard applies because physical disability always excuses failure to respond to traffic conditions
Correct Answer: A
Correct Answer Explanation: Physical disability is considered in framing the objective standard, but distraction can still be unreasonable.
Wrong Answer Explanations: B: The standard accounts for physical disability rather than pretending the impairment does not exist. C: The standard remains objective; it is not whatever this defendant subjectively thought was enough. D: Physical disability adjusts the standard; it does not create blanket immunity.
lb_rule_reference: The reasonable-person standard is objective but is adjusted for relevant physical disabilities; the question is what a reasonably prudent person with the same physical condition would do.
