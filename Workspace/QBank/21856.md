...
BARMATRIX Q#: 21856
internal_id: contracts_content_meaning_questions_batch_007_CM_C_PER_exceptions_purposes::r16::Q15
subject_display: Contracts
topic: PER exceptions and purposes
subtopic: CM-C
difficulty: Discriminator
L2: Solomon signed a written agreement to sell a machine to Rachel for $20,000. The writing states that the machine is sold “as inspected.” Rachel later discov
Stem / Fact Pattern: Solomon signed a written agreement to sell a machine to Rachel for $20,000. The writing states that the machine is sold “as inspected.” Rachel later discovers that Solomon intentionally hid a broken motor before the inspection. Rachel offers evidence of Solomon’s concealment to rescind the agreement. Solomon argues that the evidence is barred because the writing contains no warranty about the motor.
Answer A: The evidence is barred because it would add a warranty that the writing omitted.
Answer B: The evidence is admissible because it is offered to prove fraudulent concealment and avoid the contract, not to add a warranty term.
Answer C: The evidence is admissible only if the phrase “as inspected” is ambiguous.
Answer D: The evidence is barred unless Rachel proves a consistent additional term under UCC 2-202.
Correct Answer: B
Correct Answer Explanation: Rachel is not offering the evidence to add a warranty term. She is offering it to prove fraudulent concealment and avoid the agreement. The parol evidence rule does not bar extrinsic evidence offered for that defensive or equitable purpose.
Wrong Answer Explanations: A: A is wrong because the evidence is not offered as a warranty term. C: C is wrong because fraud evidence does not depend only on ambiguity. D: D is wrong because the proper route is not consistent-additional-term supplementation; it is fraud/avoidance.
lb_rule_reference: PER purpose classification
