...
BARMATRIX Q#: 20959
internal_id: contracts_content_meaning_questions_batch_006_CM_B_final_discrimination_set::r11::Q10
subject_display: Contracts
topic: Parol Evidence Rule Core — Final Discrimination Set
subtopic: CM-B
difficulty: Core Diagnostic
L2: For three prior harvest seasons, Joseph sold barley to Rachel on invoices allowing payment within 20 days. Rachel always paid within 20 days, and Joseph ac
Stem / Fact Pattern: For three prior harvest seasons, Joseph sold barley to Rachel on invoices allowing payment within 20 days. Rachel always paid within 20 days, and Joseph accepted without objection. In the current barley sale, the signed writing is silent on payment time. Joseph offers evidence of a barley-trade usage requiring payment within 10 days. Rachel offers the prior transactions.
Answer A: The trade usage controls because industry custom is always stronger than the parties’ history.
Answer B: The prior course of dealing between Joseph and Rachel controls over a conflicting general usage of trade.
Answer C: Neither source may be considered because the current writing is final.
Answer D: The court must supply a payment time without considering either source.
Correct Answer: B
Correct Answer Explanation: A course of dealing between the parties can establish a common basis of understanding and, under the hierarchy, prevails over a conflicting usage of trade. The parties’ own repeated prior practice is stronger than a general industry custom.
Wrong Answer Explanations: A: A is wrong because trade usage is subordinate to a conflicting course of dealing. C: C is wrong because UCC meaning sources may explain or supplement a final writing. D: D is wrong because agreement sources should be checked before resorting to default gap-fillers.
lb_rule_reference: Course of dealing over usage of trade
