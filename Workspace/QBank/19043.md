...
subtopic: Overbreadth and Vagueness
L2: A city ordinance prohibits "any person from making any statement, written or oral, in any public place, that is likely to annoy, upset, or offend any membe
Stem / Fact Pattern: A city ordinance prohibits "any person from making any statement, written or oral, in any public place, that is likely to annoy, upset, or offend any member of the public." A street musician is arrested after a passerby complains that his performance of original protest songs was annoying. The musician challenges the ordinance as facially unconstitutional even though, under the ordinance as written, he acknowledges that some forms of street noise might legitimately be regulated.
Call of Question: The musician's strongest constitutional challenge to the ordinance is:
Answer A: An as-applied challenge, because the musician must first show that his specific speech was protected before he can contest the law's broader sweep
Answer B: A vagueness challenge, because the term "annoying" is not precise enough for an ordinary person to know what speech is prohibited
Answer C: A facial overbreadth challenge, because the ordinance on its face prohibits a substantial amount of protected speech — all expression that might annoy or offend anyone — along with any speech that may legitimately be regulated
Answer D: A content-based challenge under strict scrutiny, because the ordinance restricts political protest songs more severely than other types of speech
Correct Answer: C
Correct Answer Explanation: An ordinance that prohibits any statement likely to "annoy, upset, or offend any member of the public" covers an enormous range of protected expression: political dissent, artistic performance, religious proselytizing, and controversial journalism could all annoy someone. The ordinance reaches far into the core of protected speech. Under the overbreadth doctrine, a law that substantially restricts protected expression may be facially invalidated. The musician may raise the facial challenge even if his own protest songs could conceivably be regulated under a narrower law.
Wrong Answer Explanations: A: The First Amendment overbreadth doctrine creates a specific exception to normal standing rules. A speaker may bring a facial challenge to a law that reaches a substantial amount of protected third-party speech, even if the challenger's own speech could be regulated. The overbreadth doctrine exists precisely because an overbroad law deters protected speech by others who will not challenge it — making facial invalidation appropriate. B: Vagueness and overbreadth are related but distinct doctrines. Vagueness challenges argue the law's terms are too unclear to give notice. Overbreadth challenges argue the law, however clear its terms, sweeps up too much protected speech. Here, the ordinance's terms are unfortunately quite clear in their sweep: any speech likely to "annoy" anyone is prohibited — which encompasses an enormous range of protected political, artistic, and expressive activity. The overbreadth claim is stronger because the law's reach is plainly too wide, not merely uncertain. D: The ordinance does not restrict speech based on content — it restricts speech based on its effect on listeners (annoying, upsetting, or offending). It applies to all annoying speech regardless of subject matter. This is more accurately an overbreadth problem: the standard ("annoying to anyone") sweeps in vast amounts of protected speech. The strongest attack is overbreadth, not content-based discrimination.
lb_rule_reference: Under the First Amendment overbreadth doctrine, a law may be invalidated on its face if it is written so broadly that it restricts a substantial amount of protected expression in addition to any speech it legitimately prohibits. Litigants may raise overbreadth even if their own speech would be unprotected.
