...
subtopic: Unprotected Categories — True Threats
L2: During an online dispute, a man posts a detailed message to a public forum stating: "I know exactly where [his neighbor] parks her car every morning and ex
Stem / Fact Pattern: During an online dispute, a man posts a detailed message to a public forum stating: "I know exactly where [his neighbor] parks her car every morning and exactly when she leaves for work. People who betray their friends deserve what happens to them. She should be very careful." The neighbor reads the post and contacts police. The man is charged under a state law prohibiting true threats. At trial, the man testifies he was "just venting frustration" and "never intended for her to actually be scared." The trial court instructs the jury that the only question is whether a reasonable person in the recipient's position would interpret the statement as a serious expression of intent to commit violence.
Call of Question: The jury instruction is:
Answer A: Correct, because true threats are determined by an objective reasonable-person standard and the speaker's subjective intent is irrelevant
Answer B: Incorrect, because the First Amendment protects any statement made in anger or frustration as long as the speaker did not specifically intend to instill fear
Answer C: Incorrect, because under Counterman v. Colorado the instruction must also require the jury to find that the defendant at least recklessly disregarded the risk his statement would be perceived as threatening
Answer D: Correct, because the man's statement is categorically unprotected as a true threat regardless of his mental state once it would cause fear in a reasonable person
Correct Answer: C
Correct Answer Explanation: In Counterman v. Colorado (2023), the Supreme Court held that the First Amendment requires at minimum a recklessness standard for true-threat prosecutions — the government must show the defendant consciously disregarded a substantial risk the communication would be perceived as threatening. A purely objective jury instruction that asks only what a reasonable recipient would perceive fails to address the defendant's mental state and is constitutionally deficient. The instruction here must be supplemented to include a finding on the defendant's subjective recklessness.
Wrong Answer Explanations: A: In Counterman v. Colorado (2023), the Supreme Court held that the purely objective reasonable-person standard is constitutionally insufficient. The First Amendment requires the government to prove some subjective mental state — at minimum recklessness — meaning the defendant must have consciously disregarded a substantial risk that his statement would be perceived as threatening. A purely objective instruction that ignores the defendant's mental state is constitutionally inadequate under current doctrine. B: Counterman does not require specific intent to threaten or specific intent to instill fear. It requires at minimum recklessness — a conscious disregard of the risk. A speaker who posts a detailed, targeted message about a neighbor's schedule and safety is not necessarily protected simply by claiming frustration. The jury must evaluate whether the speaker consciously disregarded the risk his statement would be perceived as threatening, not whether he specifically intended fear. D: Even within unprotected categories, the Supreme Court has imposed constitutional limits on how the category is defined. Counterman held that "categorically unprotected" does not mean "no mental-state requirement." For true threats specifically, the category is defined to include some subjective recklessness element. A categorical rule that ignores mental state contradicts the 2023 ruling.
lb_rule_reference: True threats are unprotected speech. Under Counterman v. Colorado (2023), the government must prove at minimum that the defendant acted recklessly — i.e., consciously disregarded a substantial risk that the statement would be perceived as threatening — in addition to showing the statement would be perceived as a serious threat by an objective reasonable person.
