...
L2: A city requires all performers at a public bandshell in a traditional public park to use the city's sound system and city-employed sound engineers. The cit
Stem / Fact Pattern: A city requires all performers at a public bandshell in a traditional public park to use the city's sound system and city-employed sound engineers. The city's stated rationale is ensuring consistent sound quality and protecting neighboring apartment buildings from excessive noise levels. The regulation applies to all performers regardless of the content or genre of their music. A jazz ensemble that regularly performs at the bandshell argues that using the city's system is an unnecessary restriction because the ensemble's own equipment is equivalent and they could self-regulate volume.
Call of Question: The sound-system requirement is most likely:
Answer A: Unconstitutional, because the government cannot control the means of speech delivery in a traditional public forum without compelling justification
Answer B: Unconstitutional, because the city must use the least restrictive means and the performers' own equivalent equipment would achieve the same noise-control objective
Answer C: Constitutional, because it is a content-neutral regulation narrowly tailored to the government's significant interest in sound quality and noise control, even though alternative approaches exist
Answer D: Constitutional only because the city owns the bandshell and may condition use of government property on any terms it chooses
Correct Answer: C
Correct Answer Explanation: The sound system requirement is content-neutral — applied to all performers regardless of message. Ward v. Rock Against Racism held that content-neutral restrictions need only be narrowly tailored in the sense of not being substantially broader than necessary, and the government need not choose the least restrictive means. Consistent noise control and sound quality management are significant government interests. The policy leaves the performers free to perform and communicate their message; it only regulates the technical means of amplification. With ample alternatives for all performers, the regulation is constitutional.
Wrong Answer Explanations: A: The regulation is content-neutral — it applies to all performers based on technical concerns about noise, not based on their message. Content-neutral regulations in traditional public forums are evaluated under intermediate scrutiny / the TPM test, not strict scrutiny. Noise control is a significant government interest, and a uniform sound system can be a narrowly tailored means of achieving it. B: Under Ward v. Rock Against Racism, narrow tailoring for content-neutral restrictions does NOT require the least restrictive means. The government must show the restriction promotes a significant interest that would be achieved less effectively without it. The city can select its sound system as a consistent, standardized solution. The mere existence of an alternative does not invalidate the regulation if the city's choice is not substantially broader than necessary. D: Government ownership does not give the government unlimited authority to impose conditions on expressive activity in a traditional public forum. The government may not restrict speech in a traditional public forum simply because it owns the property. The reason the sound-system requirement is constitutional is that it satisfies the TPM test — not government ownership.
lb_rule_reference: Under Ward v. Rock Against Racism, a content-neutral restriction on protected speech satisfies narrow tailoring if it promotes a substantial government interest that would be achieved less effectively absent the regulation. The government is not required to choose the least restrictive or least intrusive means available.
