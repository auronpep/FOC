...
BARMATRIX Q#: 19656
internal_id: contracts_content_meaning_questions_batch_006_CM_B_final_discrimination_set::r8::Q07
subject_display: Contracts
topic: Parol Evidence Rule Core — Final Discrimination Set
subtopic: CM-B
difficulty: Calibration
L2: Abraham agreed in a signed writing to sell Sarah “the orchard equipment listed in Schedule A attached to this agreement.” Schedule A, attached when both pa
Stem / Fact Pattern: Abraham agreed in a signed writing to sell Sarah “the orchard equipment listed in Schedule A attached to this agreement.” Schedule A, attached when both parties signed, listed three ladders and two carts. Abraham later argues that Schedule A is inadmissible parol evidence because the main document does not list the items itself.
Answer A: As part of the written agreement because it was attached and incorporated by reference.
Answer B: As inadmissible parol evidence because it is not printed inside the main body of the contract.
Answer C: As admissible only if Abraham orally confirmed the list after signing.
Answer D: As inadmissible unless the transaction is a services contract.
Correct Answer: A
Correct Answer Explanation: Incorporated or attached material can be part of the writing itself. Schedule A is not outside parol evidence if the signed contract refers to it and it was attached as the incorporated list.
Wrong Answer Explanations: B: B is wrong because incorporation can make an attachment part of the contract. C: C is wrong because post-signing oral confirmation is not required. D: D is wrong because incorporation applies beyond services contracts and can apply in goods transactions as well.
lb_rule_reference: Incorporation by reference / not parol
