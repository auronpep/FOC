...
BARMATRIX Q#: 17722
internal_id: contracts_content_meaning_questions_batch_007_CM_C_PER_exceptions_purposes::r5::Q04
subject_display: Contracts
topic: PER exceptions and purposes
subtopic: CM-C
difficulty: Discriminator
L2: Abraham and Naomi orally agreed that Naomi would sell Abraham 50 acres for $100,000. Their lawyer mistakenly typed “5 acres” into the final signed writing.
Stem / Fact Pattern: Abraham and Naomi orally agreed that Naomi would sell Abraham 50 acres for $100,000. Their lawyer mistakenly typed “5 acres” into the final signed writing. Both Abraham and Naomi signed without noticing the error. After Abraham pays the price, Naomi claims the writing limits the sale to 5 acres. Abraham offers negotiation notes and testimony from both parties to prove the drafting mistake and seek reformation.
Answer A: Yes, because the final writing is the best evidence of the parties’ agreement.
Answer B: Yes, because reformation is never available after a signed contract.
Answer C: No, because the evidence is offered to prove mutual mistake and support reformation, not to add an agreed term to an accurate writing.
Answer D: No, but only if Abraham proves Naomi acted fraudulently.
Correct Answer: C
Correct Answer Explanation: Extrinsic evidence may be used to prove mutual mistake and support reformation. The evidence is not being used simply to vary a correct integrated writing; it is offered to show that the writing failed to express the parties’ actual agreement because of mistake.
Wrong Answer Explanations: A: A is wrong because the final writing does not block proof that the writing itself contains a mutual mistake. B: B is wrong because reformation is an equitable route in proper cases. D: D is wrong because mutual mistake does not require fraud.
lb_rule_reference: PER defense/equity exception / mutual mistake
