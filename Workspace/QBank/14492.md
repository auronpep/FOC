...
L2: A fixtures company, in a signed writing, contracted with an apartment complex for the sale to the apartment complex of 50 identical sets of specified bathr
Stem / Fact Pattern: A fixtures company, in a signed writing, contracted with an apartment complex for the sale to the apartment complex of 50 identical sets of specified bathroom fixtures, 25 sets to be delivered on March 1, and the remaining 25 sets on April 1. The agreement did not specify the place of delivery, or the time or place of payment. On March 1, the fixtures company tendered 24 sets to the apartment complex and explained, "One of the 25 sets was damaged in transit from the manufacturer to us, but we will deliver a replacement within five days." Which of the following statements is correct?
Answer A: A: The apartment complex is entitled to accept any number of the 24 sets, reject the rest, and cancel the contract both as to any rejected sets and the lot due on April 1.
Answer B: B: The apartment complex is entitled to accept any number of the 24 sets and to reject the rest, but is not entitled to cancel the contract as to any rejected sets or the lot due on April 1.
Answer C: C: The apartment complex must accept the 24 sets but is entitled to cancel the rest of the contract.
Answer D: D: The apartment complex must accept the 24 sets and is not entitled to cancel the rest of the contract.
Correct Answer: D
Correct Answer Explanation: D is correct. The agreement between the fixtures company and apartment complex was an installment contract and the fixtures company assured the defective shipment would be cured within five days, so the apartment complex must accept the rest of the shipment and cannot cancel the remainder of the contract. A
Wrong Answer Explanations: A is incorrect. The perfect tender rule under the UCC does not apply to installment contracts. B is incorrect. As explained above, this is an installment contract and the perfect tender rule does not apply. C is incorrect. Under an installment contract, a buyer may treat the contract as breached only if the non-conformity of one or more installments substantially impairs the value of the contract as a whole.
