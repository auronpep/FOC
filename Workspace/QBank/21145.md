...
BARMATRIX Q#: 21145
internal_id: contracts_content_meaning_questions_batch_006_CM_B_final_discrimination_set::r10::Q09
subject_display: Contracts
topic: Parol Evidence Rule Core — Final Discrimination Set
subtopic: CM-B
difficulty: Discriminator
L2: Caleb agreed in a signed goods contract to sell Miriam “exactly 1,000 sacks of grain, no more and no less.” Caleb delivers 950 sacks and offers evidence th
Stem / Fact Pattern: Caleb agreed in a signed goods contract to sell Miriam “exactly 1,000 sacks of grain, no more and no less.” Caleb delivers 950 sacks and offers evidence that, in the grain trade, a 5% shortfall is commonly treated as acceptable performance. Miriam objects that the usage directly conflicts with the contract’s quantity term.
Answer A: No, because the usage cannot reasonably be reconciled with the express term requiring exactly 1,000 sacks, no more and no less.
Answer B: Yes, because trade usage always overrides express quantity terms in goods contracts.
Answer C: Yes, because any trade usage is admissible once the contract involves goods.
Answer D: No, but only because trade usage applies to delivery dates and never to quantity.
Correct Answer: A
Correct Answer Explanation: Course and usage evidence should be construed consistently with express terms when reasonable, but express terms prevail when a consistent construction is unreasonable. A usage permitting a 5% shortfall directly negates “exactly 1,000, no more and no less.”
Wrong Answer Explanations: B: B is wrong because usage does not always override express terms. C: C is wrong because Article 2 permits usage evidence only when it can function consistently or within the hierarchy. D: D is wrong because usage may address quantity in appropriate cases; it fails here because of the exact express term.
lb_rule_reference: Express term vs inconsistent usage
