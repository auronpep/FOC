...
BARMATRIX Q#: 20172
internal_id: contracts_content_meaning_questions_batch_006_CM_B_final_discrimination_set::r3::Q02
subject_display: Contracts
topic: Parol Evidence Rule Core — Final Discrimination Set
subtopic: CM-B
difficulty: Discriminator
L2: Abigail agreed in a signed writing to sell Ezekiel 500 bags of seed, with delivery “by spring planting.” The court admits proof that, in the seed trade, “b
Stem / Fact Pattern: Abigail agreed in a signed writing to sell Ezekiel 500 bags of seed, with delivery “by spring planting.” The court admits proof that, in the seed trade, “by spring planting” means no later than the week before local fields open. The fields opened on April 20, and Abigail delivered on April 14. Ezekiel sues, claiming delivery was late because the calendar spring began on March 20.
Answer A: No, because delivery on April 14 satisfied the term as explained by the trade usage.
Answer B: Yes, because the phrase must be interpreted by ordinary calendar meaning once the writing is final.
Answer C: Yes, because trade usage evidence may be admitted only for background, never to determine legal effect.
Answer D: No, but only because Ezekiel suffered no damages.
Correct Answer: A
Correct Answer Explanation: Once the accepted trade usage defines the term, legal effect follows from that meaning. If “by spring planting” means by the week before fields open, delivery on April 14 before an April 20 opening satisfied the term.
Wrong Answer Explanations: B: B is wrong because the accepted usage explains the contractual phrase. C: C is wrong because UCC meaning sources can define the agreement’s legal content. D: D is wrong because the result turns on contract meaning, not merely lack of damages.
lb_rule_reference: Same facts / different call — legal effect after usage interpretation
