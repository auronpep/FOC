...
BARMATRIX Q#: 17108
internal_id: contracts_content_meaning_questions_batch_006_CM_B_final_discrimination_set::r6::Q05
subject_display: Contracts
topic: Parol Evidence Rule Core — Final Discrimination Set
subtopic: CM-B
difficulty: Trap Repair
L2: Ruth agreed in a signed writing to buy 100 oil lamps from Jacob for a stated price. The writing was final but did not say it was complete and exclusive. Ru
Stem / Fact Pattern: Ruth agreed in a signed writing to buy 100 oil lamps from Jacob for a stated price. The writing was final but did not say it was complete and exclusive. Ruth offers proof of two prior oral statements by Jacob: first, that he would include spare wicks with the lamps; second, that Ruth could demand 150 lamps at the same price.
Answer A: Both statements, because the writing was not complete and exclusive.
Answer B: Neither statement, because both were made before the writing was signed.
Answer C: Only the statement about 150 lamps, because quantity terms are always open in goods contracts.
Answer D: Only the statement about spare wicks, because it may be a consistent additional term while the 150-lamp statement contradicts the written quantity.
Correct Answer: D
Correct Answer Explanation: Because the writing is final but not complete and exclusive, consistent additional terms may supplement it. The spare-wick promise can be treated as a consistent additional term. The 150-lamp statement contradicts the express written quantity of 100 lamps and is barred.
Wrong Answer Explanations: A: A is wrong because partial integration does not allow contradictory terms. B: B is wrong because prior terms are not all barred when the writing is only partially integrated. C: C is wrong because a quantity that contradicts the express written quantity is not automatically open.
