...
BARMATRIX Q#: 21687
internal_id: contracts_content_meaning_questions_batch_006_CM_B_final_discrimination_set::r14::Q13
subject_display: Contracts
topic: Parol Evidence Rule Core — Final Discrimination Set
subtopic: CM-B
difficulty: Core Diagnostic
L2: Eli agreed in a signed writing to buy 2,000 clay jars from Deborah. The writing stated price, quantity, and delivery date, and said it was complete, but it
Stem / Fact Pattern: Eli agreed in a signed writing to buy 2,000 clay jars from Deborah. The writing stated price, quantity, and delivery date, and said it was complete, but it did not mention packaging. Deborah offers evidence that, in the clay-jar trade, sellers pack jars in straw-lined crates unless the contract says otherwise.
Answer A: No, because a complete writing bars all usage evidence.
Answer B: No, because packaging is never part of a goods contract.
Answer C: Yes, because under Article 2 a trade usage may supplement a silent term if reasonably consistent with the writing.
Answer D: Yes, but only if Eli first proves that several jars broke in transit.
Correct Answer: C
Correct Answer Explanation: UCC 2-202 permits a final written goods contract to be explained or supplemented by usage of trade. A packaging usage that fills a silent term without contradicting price, quantity, or delivery date may be considered even if the writing is complete.
Wrong Answer Explanations: A: A is wrong because Article 2 does not treat complete writings as absolute bars to usage evidence. B: B is wrong because packaging can be a contract-content issue. D: D is wrong because the evidence is about meaning and content, not proof of damages first.
lb_rule_reference: UCC usage supplementing silent packaging term
