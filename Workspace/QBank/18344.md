...
topic: Negligence
subtopic: Duty - open and obvious conditions
L2: A hardware store placed a large display so that customers leaving the checkout area had to use a steep temporary ramp. The ramp's slope was obvious. The st
Stem / Fact Pattern: A hardware store placed a large display so that customers leaving the checkout area had to use a steep temporary ramp. The ramp's slope was obvious. The store manager knew customers carrying heavy purchases could not reasonably avoid the ramp without walking through an employee-only stockroom. A customer carrying paid merchandise fell on the ramp.
Call of Question: Which duty statement is most accurate? ### A. The obviousness of the ramp does not automatically defeat duty if the store should have anticipated invitees would encounter it anyway. - **Correct.** Open and obvious danger can affect breach or comparative fault, but it is not an automatic no-duty answer when harm should be anticipated. ### B. The store owed no duty because the ramp's slope was visible. - **Wrong.** The open-and-obvious label is not a complete duty eraser in this setting. ### C. The store owed no duty unless the customer specifically asked for a safer exit. - **Wrong.** The invitee duty does not depend on a request for protection where the possessor should anticipate the hazard. ### D. The store owed only a duty to avoid intentional injury once the customer saw the ramp. - **Wrong.** That is too narrow for invitees and misstates the effect of obvious conditions.
Answer A: The obviousness of the ramp does not automatically defeat duty if the store should have anticipated invitees would encounter it anyway
Answer B: The store owed no duty because the ramp's slope was visible
Answer C: The store owed no duty unless the customer specifically asked for a safer exit
Answer D: The store owed only a duty to avoid intentional injury once the customer saw the ramp
Correct Answer: A
Correct Answer Explanation: Open and obvious danger can affect breach or comparative fault, but it is not an automatic no-duty answer when harm should be anticipated.
Wrong Answer Explanations: B: The open-and-obvious label is not a complete duty eraser in this setting. C: The invitee duty does not depend on a request for protection where the possessor should anticipate the hazard. D: That is too narrow for invitees and misstates the effect of obvious conditions.
lb_rule_reference: An open and obvious condition does not automatically eliminate a possessor's duty to an invitee when the possessor should anticipate that the invitee will encounter the hazard despite the obviousness.
