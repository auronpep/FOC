...
subtopic: Forum Analysis — Designated Public Forum
L2: A county owns an auditorium used primarily for government meetings and cultural events produced by the county. Three years ago, the county manager issued a
Stem / Fact Pattern: A county owns an auditorium used primarily for government meetings and cultural events produced by the county. Three years ago, the county manager issued a policy stating: "The County Auditorium is open for rental by any member of the public for expressive events including lectures, rallies, debates, and performances, subject only to a reasonable fee and advance reservation." The policy has been followed consistently, and dozens of community groups — civic, religious, political, and commercial — have used the space. A local group seeking to organize a debate on immigration policy applies to rent the auditorium. The county denies the application, citing a newly enacted guideline that prohibits "events promoting or opposing positions on any federal immigration policy" because county leadership wishes to avoid controversy.
Call of Question: The group's most likely First Amendment claim is:
Answer A: The denial is constitutional because the auditorium is government property not traditionally open to the public, so the county may restrict use on any rational basis
Answer B: The denial is constitutional under intermediate scrutiny because the county has an important interest in avoiding political controversy in government facilities
Answer C: The denial is an unconstitutional content-based restriction in a designated public forum, subject to strict scrutiny the county cannot satisfy
Answer D: The denial may be unconstitutional, but the group's best argument is that the county's action constitutes viewpoint, not subject-matter, discrimination, because the guidelines prefer no-immigration-debate speakers
Correct Answer: C
Correct Answer Explanation: The county's three-year policy of opening the auditorium to all expressive events created a designated public forum. Content-based restrictions in a designated public forum must survive strict scrutiny. Excluding events on the basis of subject matter — here, federal immigration policy — is a content-based restriction. Avoiding controversy is not a compelling interest, and a blanket topic exclusion is not narrowly tailored. The denial is unconstitutional.
Wrong Answer Explanations: A: The county has intentionally opened the auditorium to indiscriminate public expression for years. That deliberate and consistent opening creates a designated public forum. In a designated public forum, the government cannot apply content-based restrictions (such as excluding immigration-topic events) without satisfying strict scrutiny — the same standard that applies in traditional public forums. B: The new guideline is not content-neutral — it targets speech on a specific topic (immigration policy) based on its subject matter. Content-based restrictions in a designated public forum require strict scrutiny, not intermediate scrutiny. Avoiding controversy is not a compelling interest, and even if it were, excluding one topic entirely is not narrowly tailored. D: Whether this qualifies as subject-matter restriction or viewpoint discrimination, it is unconstitutional in a designated public forum. The stronger and simpler legal theory is content-based restriction in a designated forum — which is what the call of the question asks. While the group could argue viewpoint discrimination, the core analytical error in D is that it frames this as requiring viewpoint discrimination to win, when a subject-matter restriction alone is sufficient under strict scrutiny.
lb_rule_reference: A designated public forum is created when the government intentionally opens a nontraditional venue for indiscriminate public use for expressive activity. While the forum remains open, content-based restrictions must survive strict scrutiny; content-neutral TPM restrictions must meet the same intermediate standard as in traditional public forums.
