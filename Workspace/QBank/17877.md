...
BARMATRIX Q#: 17877
internal_id: presentation_questions_batch_010_B2_common_objections::r11::Q10
subject_display: Evidence
topic: Common objections to questions
subtopic: B2
difficulty: Calibration
L2: In a federal breach-of-contract trial, Priscilla asks Aquila, “When did Peter do that thing?” Peter objects to the question. What is the best objection?
Stem / Fact Pattern: In a federal breach-of-contract trial, Priscilla asks Aquila, “When did Peter do that thing?” Peter objects to the question. What is the best objection?
Answer A: Hearsay.
Answer B: Vague and ambiguous.
Answer C: Calls for a legal conclusion.
Answer D: Improper character evidence.
Correct Answer: B
Correct Answer Explanation: The question does not identify what “that thing” means, so the witness and opposing party cannot tell what event is being asked about. The best objection is vague and ambiguous.
Wrong Answer Explanations: A: A is wrong because the question does not necessarily call for an out-of-court statement. C: C is wrong because it does not ask for a legal conclusion. D: D is wrong because it does not ask about character.
