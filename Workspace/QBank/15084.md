...
L2: The owner of Blackacre is an elderly, unmarried man with no children and no surviving relatives. Blackacre is a large property bordered by forests on the e
Stem / Fact Pattern: The owner of Blackacre is an elderly, unmarried man with no children and no surviving relatives. Blackacre is a large property bordered by forests on the east side, a small stream on the west side, a large hill to the south, and a meadow to the north. There are neighbors to the east, west, and south. The owner would like to leave Blackacre to the neighbor over the hill, but has neglected to do anything about it. While on vacation in Europe, the owner suffered a bad fall and was hospitalized. The prognosis for his recovery is not good, and the owner became afraid that the state of his health may prevent him from returning home, so he hired an agent to handle his business affairs in the United States. Over the phone, the owner orally gave the agent authority to promptly convey Blackacre to the neighbor in person. The agent went to the neighbor's home with the proper documents, which the agent executed. On the deed, the agent signed the owner's name. Is the deed valid?
Answer A: A: Yes, because the agent was authorized to execute the deed.
Answer B: B: Yes, because the agent signed the owner's name.
Answer C: C: No, because the agent's authority was not in writing.
Answer D: D: No, because a non-attorney agent may not execute a deed.
Correct Answer: C
Correct Answer Explanation: C is correct. The deed is not valid because the agent did not have written authority to sign for the owner.
Wrong Answer Explanations: A is incorrect. As stated above, the agent needed written authority to execute the deed but only had oral authority. B is incorrect. The agent did not have the proper written authority to sign for the owner. D is incorrect. A non-attorney agent may execute a deed if properly authorized to do so.
