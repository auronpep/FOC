...
BARMATRIX Q#: 21109
internal_id: contracts_content_meaning_questions_batch_006_CM_B_final_discrimination_set::r2::Q01
subject_display: Contracts
topic: Parol Evidence Rule Core — Final Discrimination Set
subtopic: CM-B
difficulty: Core Diagnostic
L2: Abigail agreed in a signed writing to sell Ezekiel 500 bags of seed. The writing stated that delivery would occur “by spring planting,” but did not define
Stem / Fact Pattern: Abigail agreed in a signed writing to sell Ezekiel 500 bags of seed. The writing stated that delivery would occur “by spring planting,” but did not define that phrase. In the seed trade in that region, “by spring planting” regularly means no later than the week before local fields open for planting. Abigail offers evidence of that trade usage to explain the delivery term.
Answer A: No, because the writing is final and trade usage is always parol evidence.
Answer B: Yes, because trade usage may explain or supplement a final goods contract if reasonably consistent with the written term.
Answer C: No, because delivery terms can be proved only from the four corners of the writing.
Answer D: Yes, but only if Ezekiel first proves that Abigail breached the delivery term.
Correct Answer: B
Correct Answer Explanation: Under Article 2, a final written expression may be explained or supplemented by usage of trade if the usage is reasonably consistent with the written terms. The evidence defines the phrase “by spring planting”; it does not add a separate obligation or contradict an express date.
Wrong Answer Explanations: A: A is wrong because UCC 2-202 expressly allows usage of trade to explain or supplement a final writing. C: C is wrong because Article 2 does not use an absolute four-corners rule for goods contracts. D: D is wrong because admissibility of meaning evidence is decided before the merits issue whether Abigail breached.
lb_rule_reference: UCC 2-202 / trade usage explaining ambiguous delivery term
