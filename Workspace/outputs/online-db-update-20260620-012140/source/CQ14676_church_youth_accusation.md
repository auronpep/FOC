...
```json
{
  ...
  "c3": {
    ...
    "difficulty": "UNKNOWN",
    "distractors": [],
    "analyzer_notes": "drift_audit: structural repair only; transformed_from: 14676; letter_map: A\u001eC, B\u001eA, C\u001eB, D\u001eD",
    "gold_keys": [],
    "silver_keys": []
  }
}
...
```json
{
  ...
  "outline_mastery": {
    "placement": "74020102",
    "this_item_teaches": "A defendant is not guilty of manslaughter when the death is caused by an independent, voluntary intervening act (like the victim's suicide) that severs the defendant's proximate causation.",
    "fills": [],
    "adjacent_to_master": []
  }
}
...
Did the defendant's act proximately cause the death or was suicide a superseding intervening act?
...
A defendant is not guilty of manslaughter when the death is caused by an independent, voluntary intervening act (like the victim's suicide) that severs the defendant's proximate causation.
