...
```
1. **program_frame:** Question 17930; source 17930.
...
```json
{
  ...
  "c3": {
    ...
    "difficulty": "UNKNOWN",
    "distractors": [],
    "analyzer_notes": "drift_audit: structural repair only; transformed_from: 17930; letter_map: see Letter Map section",
    "gold_keys": [],
    "silver_keys": []
  }
}
