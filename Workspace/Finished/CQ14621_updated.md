...
```
1. **program_frame:** Question 14621; source 14621.
...
```json
{
  ...
  "c3": {
    ...
    "difficulty": "UNKNOWN",
    "distractors": [],
    "analyzer_notes": "drift_audit: structural repair only; transformed_from: 14621; letter_map: see Letter Map section",
    "gold_keys": [],
    "silver_keys": []
  }
}
