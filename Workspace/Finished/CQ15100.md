...
```json
{
  ...
  "wrong_answer_paths": [
    ...
    {"choice":"B","filter_broken":"NOT_TRUE","mold":"EAR_FALSITY","why_a_student_picks_this":"Assumes additional loss-of-use makes it "more correct"","recovery_step":"Contrast repair remedies vs FMV election"},
