...
```
1. **program_frame:** Question 17564; source 17564.
...
```json
{
  ...
  "c3": {
    ...
    "difficulty": "UNKNOWN",
    "distractors": [],
    "analyzer_notes": "drift_audit: structural repair only; transformed_from: 17564; letter_map: see Letter Map section",
    "gold_keys": [],
    "silver_keys": []
  }
}
